...
DATABASES = {
    'default': {
        ...
        'NAME': 'agenvida',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'f=$roc7w+tdx-!-yi*$4oyg6e$t$jwvk%f&g^xfltfo-a54ovl'
...
#Django REgistration
REGISTRATION_DEFAULT_GROUP_NAME= 'Usuarios'
