...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Proposito', fields ['usuario']
        db.delete_unique(u'principal_proposito', ['usuario_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'Proposito', fields ['usuario']
        db.create_unique(u'principal_proposito', ['usuario_id'])
