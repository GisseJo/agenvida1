...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vinculacion.vinculacion'
        db.alter_column(u'principal_vinculacion', 'vinculacion', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserProfile.sexo'
        db.alter_column(u'principal_userprofile', 'sexo', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserProfile.pais'
        db.alter_column(u'principal_userprofile', 'pais', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserProfile.grupo_de_vida'
        db.alter_column(u'principal_userprofile', 'grupo_de_vida', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):

        # Changing field 'Vinculacion.vinculacion'
        db.alter_column(u'principal_vinculacion', 'vinculacion', self.gf('django.db.models.fields.TextField')())

        # Changing field 'UserProfile.sexo'
        db.alter_column(u'principal_userprofile', 'sexo', self.gf('django.db.models.fields.TextField')())

        # Changing field 'UserProfile.pais'
        db.alter_column(u'principal_userprofile', 'pais', self.gf('django.db.models.fields.TextField')(max_length=50))

        # Changing field 'UserProfile.grupo_de_vida'
        db.alter_column(u'principal_userprofile', 'grupo_de_vida', self.gf('django.db.models.fields.TextField')(max_length=140))
