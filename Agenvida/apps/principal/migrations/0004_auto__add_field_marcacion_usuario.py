...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Marcacion.usuario'
        db.add_column('principal_marcacion', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Marcacion.usuario'
        db.delete_column('principal_marcacion', 'usuario_id')
    ...
    models = {
        ...
        'principal.marcacion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proposito': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['principal.Proposito']"}),
        ...
        'principal.proposito': {
            ...
            'usuario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'vinculacion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['principal.Vinculacion']"})
        },
