...
def libro_pdf(request):
    ...
    html = render_to_string('libro_pdf.html',  {'pagesize':'A4', 'prop_dios':prop_dios, 'prop_losdemas':prop_losdemas, 'prop_conmigo':prop_conmigo, 'prop_naturaleza':prop_naturaleza }, context_instance=RequestContext(request))
